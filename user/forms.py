...
class ProfileForm(ModelForm):
    ...
    def clean_name(self):
        ...
        if not re.fullmatch('[a-zA-Z]+', name):
            raise forms.ValidationError(("You can't have special characters in your name, unless you're Musk"), code='name_number')
        return name
    ...
    def clean_surname(self):
        ...
        if not re.fullmatch('[a-zA-Z]+', surname):
            raise forms.ValidationError(("You can't have special characters in your name, unless you're Musk"), code='surname_number')
        return surname
