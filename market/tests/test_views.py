...
class TestViews(TestCase):
    ...
    def test_catalog_not_your_products(self):
        ...
        item = CatalogItem.objects.create(user=user, product=prod, quantity=3, price=2)
        item.save()
    ...
    def test_add_item_paths(self):
        ...
        self.assertTemplateUsed(
            post_response, "market/insert.html"
        )  # post with no arguments
    ...
    def test_add_item_price_over_limit(self):
        ...
        self.assertFormError(
            ...
            "catalog_form",
            "price",
            "You can't sell at more than price limit!",
        )
        self.client.logout()
    ...
    def test_add_item_product_name_required(self):
        ...
        response = self.client.post(
            self.add_item_url,
            {"product-category": "Food", "catalog-price": 2, "catalog-quantity": 2},
        )

        self.assertFormError(
            response, "product_form", "name", "This field is required."
        )
        self.client.logout()
    ...
    def test_add_item_product_category_required(self):
        ...
        response = self.client.post(
            self.add_item_url,
            {"product-name": "Pasta", "catalog-price": 2, "catalog-quantity": 2},
        )

        self.assertFormError(
            response, "product_form", "category", "This field is required."
        )
        self.client.logout()
    ...
    def test_add_item_product_price_required(self):
        ...
        self.assertFormError(
            response, "catalog_form", "price", "This field is required."
        )
        self.client.logout()
    ...
    def test_add_item_product_quantity_required(self):
        ...
        response = self.client.post(
            self.add_item_url,
            {"product-name": "Pasta", "product-category": "Food", "catalog-price": 2},
        )

        self.assertFormError(
            response, "catalog_form", "quantity", "This field is required."
        )
        self.client.logout()
    ...
    def test_buy_item_paths(self):
        ...
        self.assertEquals(
            post_response.url,
            self.catalog_url + "/Something%20wrong%20with%20your%20request.",
        )  # post with no arguments
    ...
    def test_buy_item_validated_post(self):
        ...
        post_response = self.client.post(
            self.buy_item_url, {"item_id": "1", "quantity": 2}
        )
    ...
    def test_buy_item_no_id(self):
        ...
        post_response = self.client.post(self.buy_item_url, {"quantity": 2})
    ...
    def test_buy_item_no_quantity(self):
        ...
        post_response = self.client.post(self.buy_item_url, {"item_id": "1"})
    ...
    def test_buy_item_not_found_in_catalog(self):
        ...
        self.assertEquals(
            post_response.url,
            self.catalog_url
            + "/Couldn't%20find%20the%20item%20requested%20in%20catalog.",
        )
        self.client.logout()
    ...
    def test_buy_item_quantity_over_limit(self):
        ...
        post_response = self.client.post(
            self.buy_item_url, {"item_id": "1", "quantity": 4}
        )
        ...
        self.assertEquals(
            post_response.url,
            self.catalog_url
            + "/You%20tried%20to%20buy,%20but%20we%20don't%20have%20that%20much!",
        )
        self.client.logout()
    ...
    def test_buy_item_price_over_limit(self):
        ...
        item = CatalogItem.objects.create(
            ...
            product=prod,
            quantity=3,
            price=201 + BALANCE_LIMIT,
        )

        post_response = self.client.post(
            self.buy_item_url, {"item_id": "1", "quantity": 1}
        )
        ...
        self.assertEquals(
            post_response.url,
            self.catalog_url
            + "/You%20don't%20have%20enough%20credits%20(limit%20reached).",
        )
        self.client.logout()
    ...
    def test_buy_item_seller_balance_over(self):
        ...
        item = CatalogItem.objects.create(
            user=user, product=prod, quantity=3, price=200
        )
    ...
    def test_buy_item_not_removed_item(self):
        ...
        self.assertEquals(post_response.status_code, 200)
        self.assertTrue(CatalogItem.objects.get(id=item.id).quantity == 1)
        self.client.logout()
    ...
    def test_buy_item_removed_item(self):
        ...
        post_response = self.client.post(
            self.buy_item_url, {"item_id": "1", "quantity": 3}
        )

        self.assertEquals(post_response.status_code, 200)
        self.assertFalse(CatalogItem.objects.filter(id=item.id))
        self.client.logout()
    ...
    def test_buy_item_tracks_created(self):
        ...
        self.assertTrue(
            Product_pricetracker.objects.filter(seller=user, product=prod, price=2)
        )
        self.client.logout()
    ...
    def test_remove_item_paths(self):
        ...
        self.assertEquals(
            post_response.url,
            self.user_items_url + "/Something%20wrong%20with%20your%20request.",
        )  # post with no arguments
    ...
    def test_remove_item_validated_post(self):
        ...
        post_response = self.client.post(self.remove_item_url, {"item_id": 1})
    ...
    def test_remove_item_not_found(self):
        ...
        post_response = self.client.post(self.remove_item_url, {"item_id": 2})
